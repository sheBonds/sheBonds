...
<body class="clinic_version">
         ...
         <div class="row">
            ...
            <div class="search" style="text-align: center">
               <form action="event_detail.php" method="POST">
                  <input type="text" size="40" name="searchevent" placeholder="Enter event name to search event"
    			...
    			?>
                  ...
                  <div class="message-box ">
                     ...
                     <h4 style="height: 20px;">
                        <input style="border: none ; text-align: center;" class='event_name' id="joineventname"
                           type='text' name='joineventname' value='<?php echo $row["EventName"] ; ?>' hidden>
 ...
 -->
                     ...
                     <button type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#message">Message</button>
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <div class="footer-info padding">
                  <h3>CONTACT US</h3>
                  <p><i class="fa fa-map-marker" aria-hidden="true"></i> PO Box 16122 Collins Street West Victoria 8007
                     Australia</p>
