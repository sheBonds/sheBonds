...
background-image: url(images/bg-testimonial.png);
 ...
 <!-- <div id="testimonials" class="section wb wow fadeIn"> -->
	...
	<form action="change_password.php" method="POST">
					...
					<input type="password" name="original" placeholder="Current Password" class="form-control" required>
					</div>

					<div class="form-group">
          			<label for="user" class="font-weight-bold"> New Password: </label>
					<input type="password" name="new" placeholder="New Password" class="form-control" minlength="8" maxlength="12" required>
					</div>

					<br><br>
					<div class="form-group">
          			<label for="user" class="font-weight-bold">Re-enter New Password: </label>
					<input type="password" name="reenter" class="form-control" placeholder="Re-enter New Password"   required>
					</div>
					<br><br><br>
